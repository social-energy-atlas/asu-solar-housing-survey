...
Contributors
Clark Miller <clark.miller@asu.edu> 
 
Completion Date
First data Import: 09/21/15
Online Poll closed: 03/28/16
Final Import: 03/28/16
 
Rights
There are no rights or access restrictions associated with this dataset. 
________________
Research Study Description
1-2 paragraphs describing the content (think of it as an abstract). It should include the purpose of the study, as well as the specific research questions or hypotheses that were being investigated by creating the dataset.
...
Description of and details for all questions/fields included in survey (including the exact language presented to respondents)
...
Measures
Description of what was being measured in each question, along with the exact language of any fixed responses.
...
Data Description
3-4 paragraphs describing the resulting dataset from the study. This should include a description of the intellectual content, as well as an audit trail of its Q/A process.
...
Q4 - What is the size of your solar PV system? (in kW)
This question had a lot of quality control applied to it. Respondents often gave answers in what appeared to be watts (W), not kilowatts (kW). Sometimes they indicated that they weren’t sure or gave answers that had to do with some other calculation instead. For those that appeared to simply answer in W instead of kW, we checked the size of the home and panels using Google earth. Where the size of the home and its installed panels appeared to be logical and reasonable, we made the adjustment to comply with kW readings. 
...
File architecture
A description of the individual files within the dataset, including their file types, any manipulation of those files before being shared. There should also be a description of the relationships between individual files or entities/database schemas.


This data set is in a flat file saved in .csv format. It is named: “SH_Survey_Data”. The vast majority of the data was collected via paper surveys and input into the online Qualtrics survey portal. It was then exported as .csv files and imported in batches into a Filemaker Pro database for easy viewing and analysis. Once the data was input, organized, anonymized (eg. removing personal information such as name and phone number or other contact information that respondents provided in the survey, even though this information was not requested) it was exported again to .csv format. 
Database Schema Image
 
  SH_Survey_DataArchitectureMap.png 
Variable Description
1-2 paragraphs providing all of the information necessary for understanding the variables contained within the data. This should include variable descriptions, as well as permitted values and meaning. You should also provide any context needed for understanding the nature in which it was completed. This should only be a cursory, descriptive analysis of what is in the dataset. We will do a more robust analysis in a resulting whitepaper.
